...
public class PersonItemProvider
	...
	protected void addIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_identifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_identifier_feature", "_UI_Person_type"),
				 AddressbookPackage.Literals.PERSON__IDENTIFIER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Person)object).getFamilyName();
